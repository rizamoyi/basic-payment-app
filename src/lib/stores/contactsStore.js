 ...
 * required: `favourite`, `address`, and `name`. When this data is passed to the
 ...
 * @property {boolean} favourite Whether or not the contact is marked as a "favorite"
...
function createContactsStore() {
	...
	return {
		...
		/**
		 * Toggles the "favourite" field on the specified contact.
